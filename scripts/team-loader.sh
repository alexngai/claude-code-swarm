...
echo ""
echo "1. Call **TeamCreate** to set up a native Claude Code team"
echo "2. Spawn a **coordinator agent** (the root role) as a team member with \`team_name\`"
echo "3. The coordinator creates tasks via **TaskCreate** and spawns agents with \`team_name\`"
echo "4. All agents coordinate via **SendMessage** and track progress via **TaskUpdate**"
echo ""
...
echo "### Coordination"
echo ""
echo "This team uses Claude Code's native team features:"
echo "- **TaskCreate/TaskUpdate** for task lifecycle"
echo "- **SendMessage** for agent-to-agent communication"
echo "- **TeamCreate** for team setup"
echo ""
echo "**MAP (if enabled):** Lifecycle events are emitted for external observability."
echo "Agents do not interact with MAP directly."
